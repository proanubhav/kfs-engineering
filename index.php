...
<html lang="zxx">
    ...
    <body>
        ...
        <section class="offer-area pb-100 pt-100">
            <div class="container">
                <div class="section-title">
                    <span class="sub-title">Products</span>
                    <h2>Products We Offer You From Our Company</h2>
                </div>
        ...
        <!-- About -->
        <section class="about-area-two pt-100">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
        ...
        <!-- Benefit -->
        <section class="benefit-area benefit-area-two">
            <div class="container-fluid">
                <div class="row m-0">
                    <div class="col-lg-7">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="social-content">
                            ...
                            <p><i class="fa fa-angle-double-right" aria-hidden="true"></i> Diverse range of testing equipments.</p>
                            <a class="cmn-btn" href="#">
                                Know Details
                                <i class='bx bx-right-arrow-alt'></i>
                            </a>
        ...
        <div class="book-area">
            <div class="container-float">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="book-img">
                            <img src="assets/img/home-two/book-main.jpg" alt="Book">
                        </div>
                    </div>
                    <div class="col-lg-6">
